class BuyDelivery
  ...
  attr_accessor :item_id, :user_id, :buy_id, :postal_code, :prefecture_id, :city, :addresses, :building, :phone_number
  

  with_options presence: true do
    validates :postal_code, :prefecture_id, :city, :addresses, :phone_number
